...
int main ()
{
  ...
  do
  {
    ...
    switch(choice)
    {
      case 1: if(insertAtEnd(namesForPets,petName,elementsInArray) == 1)
              {cout << "\n\n\tThe pet name " << petName << " was added at the end of the list.\n"; elementsInArray++; break;}

      case 2: if(insertAt(namesForPets,petName,index,elementsInArray)== 1)
              {cout << "\n\n\tThe pet name " << petName << " was added at the beginning of the list.\n"; elementsInArray++; break;}

      case 3: if(insertAt(namesForPets,petName,index,elementsInArray)== 1)
      ...
      case 7: cout << "\n\n\tThe list of pet names is: \n";
              printList(namesForPets,elementsInArray);
              break;
